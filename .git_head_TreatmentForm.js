                ...
                <div className={styles['treatment-form']}>
                    ...
                    <div className={styles['treatment-header']} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px', width: '100%' }}>
                        ...
                        <div style={{ flex: 1, textAlign: 'center' }}>
                            <h1 style={{ fontSize: '1.2rem', margin: '0 0 5px 0' }}>Zool├│gico Regional Miguel ├ülvarez del Toro</h1>
                            <h2 style={{ fontSize: '1rem', fontStyle: 'italic', margin: '0 0 10px 0', color: '#555' }}>Cl├¡nica Veterinaria</h2>
                    ...
                    <div className={styles['form-section']}>
                        ...
                        <div className={styles['form-grid-2']}>
                            <div className={`${styles['form-group']} ${styles['compact']}`}>
                                ...
                                <input type="text" className={styles['form-input']} placeholder="Nombre cient├¡fico" defaultValue={patient?.scientificName || ''} />
                            </div>
                            <div className={`${styles['form-group']} ${styles['compact']}`}>
                                <label>Nombre com├║n</label>
                                <input type="text" className={styles['form-input']} placeholder="Nombre com├║n" defaultValue={patient?.commonName || ''} />
                            </div>
                        </div>
                        <div className={styles['form-grid-4']}>
                            ...
                            <div className={`${styles['form-group']} ${styles['compact']}`}>
                                <label>Edad</label>
                                <input type="text" className={styles['form-input']} placeholder="Edad" defaultValue={patient?.age ? `${patient.age} a├▒os` : ''} />
                            </div>
                            <div className={`${styles['form-group']} ${styles['compact']}`}>
                                <label>Ubicaci├│n</label>
                                <input type="text" className={styles['form-input']} placeholder="Ubicaci├│n" defaultValue={patient?.location || ''} />
                            </div>
                        </div>
                        <div className={styles['form-grid-2']}>
                            <div className={`${styles['form-group']} ${styles['compact']}`}>
                    ...
                    {/* Impresiones Diagn├│sticas - SOLO variante Aves */}
                    {variant === 'aves' && (
                        <div className={styles['form-section']}>
                            <h4 className={styles['section-title']}>Impresiones Diagn├│sticas</h4>
                            <textarea className={`${styles['form-input']} ${styles['full-textarea']}`} rows="2" placeholder="Impresiones diagn├│sticas"></textarea>
                        </div>
                    )}
                    ...
                    <div className={styles['treatment-footer']}>
                        <div className={styles['footer-field']}>
                            <label>Responsable cl├¡nico:</label>
